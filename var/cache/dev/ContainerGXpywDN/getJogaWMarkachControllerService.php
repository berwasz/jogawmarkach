 ...
 */
class getJogaWMarkachControllerService extends App_KernelDevDebugContainer
{
    /**
     * Gets the public 'App\Controller\JogaWMarkachController' shared autowired service.
     *
     * @return \App\Controller\JogaWMarkachController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'framework-bundle'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'AbstractController.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Controller'.\DIRECTORY_SEPARATOR.'JogaWMarkachController.php';

        $container->services['App\\Controller\\JogaWMarkachController'] = $instance = new \App\Controller\JogaWMarkachController();
        ...
        ]))->withContext('App\\Controller\\JogaWMarkachController', $container));
